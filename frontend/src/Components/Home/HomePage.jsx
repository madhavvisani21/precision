...
export const HomePage = () => {
  ...
  return (
    <Box bg="#fafafa" color="#333" fontFamily="Helvetica, sans-serif">
      <HomeNavbar />
      <Box mt="90px">
        <AutoSlider />
        <Box
          ...
          zIndex="100"
          position="relative"
          m={{ base: "-250px auto 0px", sm: "-150px auto 0px", md: "-60px auto 30px", lg: "-50px auto", xl: "50px auto 50px" }}
        >
              ...
              <Link key={el.id} to={el.href}>
                ...
                >
                  ...
                  >
                    ...
                    <Text fontSize="16px" fontWeight="bold">{el.iconName}</Text>
                  </Flex>
                </Box>
              </Link>
            ))}
        ...
        <Box
          ...
          textAlign="left"
          p={{ base: "120px 10px 50px 10px", sm: "120px 10px 50px 10px", md: "120px 10px 50px 10px", lg: "120px 0px 50px 50px" }}
        >
          <Box
            width={{ base: "90%", md: "20%", sm: "95%", lg: "15%" }}
            ml={{ sm: "5%", md: "5%", lg: "10%", base: "5%" }}
          >
            <Text
              fontSize="22px"
              fontWeight="600"
